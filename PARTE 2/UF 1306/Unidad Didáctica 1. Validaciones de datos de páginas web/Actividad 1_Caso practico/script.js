...
function validarFormulario(event) {
    ...
    // e. Validar que el campo edad no está vacío y contiene números entre 0 y 120.
    if (edadVal === '') {
    ...
    if (isNaN(edadNum) || edadNum < 0 || edadNum > 120) {
        $mensajeDiv.text("La edad debe ser un número entero entre 0 y 120").css('color', 'red');
        $edad.focus();
        return false;
    }
    ...
    // g. Validar el campo mensaje para que no pueda contener más de 255 caracteres.
